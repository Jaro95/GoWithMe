...
<div class="w3-display-container w3-light-grey contact" id="adminPanel">
        ...
        <table id="admin" class="display">
            ...
            <c:forEach items="${userDetails}" var="userDetail">
                <tr>
                    ...
                    <td>
                        <button class="w3-button w3-black" onclick="location.href='/gowithme/admin/update?id=${userDetail.user.id}'">
