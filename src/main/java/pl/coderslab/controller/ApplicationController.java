...
public class ApplicationController {
    ...
    public String getProfile(Model model) {
        ...
        CustomUserDetails userDetailsLogin = (CustomUserDetails) authentication.getPrincipal();
        UserDetails userDetails = userDetailsRepository.findByUserId(userDetailsLogin.getId());
